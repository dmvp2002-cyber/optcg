...
# Static Collectr snapshots (generated by Playwright)
...
def extract_versions(card_code: str):
    """
    Discover all printed versions for a card
    """
...
def scrape_card_price(card_id: str):
    """
    Fetch EUR + USD price for a single card version
    """
    try:
...
# ------------------------------------------------------
# COLLECTR — LOAD STATIC SNAPSHOT (NO SCRAPING)
# ------------------------------------------------------
