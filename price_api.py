...
# NEW: static Collectr data (generated by Playwright)
...
def load_collectr_items(path: str, prefix: str):
    """
    Loads Collectr prices from JSON files generated by Playwright.
    """
...
# ------------------------------------------------------
# COLLECTR LIVE PRICE ENDPOINTS (JSON-BASED)
# ------------------------------------------------------
@app.get("/prices/dons")
def get_dons_prices():
    ...
    return {
        ...
        "count": len(items),
        "cached": True,
        "updated_at": _mtime_iso(DONS_FILE),
        "items": items,
    }
...
def get_sealed_prices():
    ...
    return {
        ...
        "count": len(items),
        "cached": True,
        "updated_at": _mtime_iso(SEALED_FILE),
        "items": items,
    }
...
def refresh_collectr():
    return {
        ...
        "dons": len(load_collectr_items(DONS_FILE, "don")),
        "sealed": len(load_collectr_items(SEALED_FILE, "sealed")),
    }
